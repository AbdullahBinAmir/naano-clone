    ...
    <>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
        ...
        <StatTile
          ...
          value={creatorsInNetwork}
          caption="Marketplace-visible right now"
        />
      </div>
      ...
      <GlassCard>
        ...
        <p className="mt-1 text-sm text-foreground-muted">
          You&apos;re on the <span className="font-medium text-foreground">{planTier === "managed" ? "Managed" : "Self-Serve"}</span> plan.
        </p>
      </GlassCard>
    </>
  );
